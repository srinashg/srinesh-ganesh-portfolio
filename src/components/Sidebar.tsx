...
function GlobeIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="h-4 w-4" aria-hidden="true">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 12h18M12 3a14.5 14.5 0 0 1 0 18M12 3a14.5 14.5 0 0 0 0 18" />
    </svg>
  );
}
...
export default function Sidebar() {
  return (
    ...
    >
      ...
      <div className="sidebar-panel rounded-2xl bg-gray-100 p-6">
        <h2 className="text-sm font-bold uppercase tracking-wide text-black">Social Links</h2>
        <ul className="mt-4 flex flex-col gap-3 text-sm text-black">
          <li className="flex items-center gap-2">
            <LinkedInIcon />
            <a
