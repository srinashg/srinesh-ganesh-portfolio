  ...
  return (
    <section id="home" aria-labelledby="home-heading" className="scroll-mt-24">
      <div className="body-panel rounded-2xl bg-white p-8 sm:p-12">
        <p className="mb-3 inline-flex rounded-full bg-gradient-to-r from-blue-500 to-blue-700 px-4 py-1 text-xs font-bold tracking-wide text-white">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <a href={`mailto:${profile.email}`} className="nav-pill nav-pill--inactive">
            Get in Touch
          </a>
        </div>
      </div>
